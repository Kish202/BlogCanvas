...
const BlogInteraction = () => {
    ...
    return (
        <>
            ...
            <div className='relative z-10 flex gap-6 justify-between'>
                ...
                <div className='flex gap-6 items-center'>
                    ...
                    <button
                        className="w-10 h-10 rounded-full flex items-center justify-center bg-grey/80 hover:bg-purple/20 hover:text-purple"
                        title="Remix this post"
                        onClick={() => document.getElementById("remix-lab")?.scrollIntoView({ behavior: "smooth", block: "start" })}
                    >
            ...
            <div className='relative z-10 flex items-center justify-between gap-4 py-3'>
                <InkPalette />
                <p className='text-sm text-dark-grey hidden sm:block'>leave a blot</p>
            </div>
            <hr className='border-grey my-2' />
        </>
    )
